...
#define R__DICTIONARY_FILENAME dIhomedIkmseodIWorksdImuon_3dO1dO2dItmpdILinux5dO14mIGCC_11_3dIRawObjsdIlibRawObjsmIshareddIFChannelData_dict
...
namespace ROOT {
   ...
   {
      return GenerateInitInstanceLocal((::FChannelData*)nullptr);
   }
   // Static variable to force the class initialization
   static ::ROOT::TGenericClassInfo *_R__UNIQUE_DICT_(Init) = GenerateInitInstanceLocal((const ::FChannelData*)nullptr); R__UseDummy(_R__UNIQUE_DICT_(Init));
...
namespace {
  void TriggerDictionaryInitialization_libRawObjs_FChannelData_dict_Impl() {
    static const char* headers[] = {
"RawObjs/FChannelData.hh",
nullptr
    };
...
#line 1 "libRawObjs_FChannelData_dict dictionary forward declarations' payload"
#pragma clang diagnostic ignored "-Wkeyword-compat"
#pragma clang diagnostic ignored "-Wignored-attributes"
#pragma clang diagnostic ignored "-Wreturn-type-c-linkage"
extern int __Cling_AutoLoading_Map;
class __attribute__((annotate("$clingAutoload$RawObjs/FChannelData.hh")))  FChannelData;
)DICTFWDDCLS";
    static const char* payloadCode = R"DICTPAYLOAD(
#line 1 "libRawObjs_FChannelData_dict dictionary payload"
...
nullptr
    ...
    if (!isInitialized) {
      TROOT::RegisterModule("libRawObjs_FChannelData_dict",
        headers, includePaths, payloadCode, fwdDeclCode,
        TriggerDictionaryInitialization_libRawObjs_FChannelData_dict_Impl, {}, classesHeaders, /*hasCxxModule*/false);
      isInitialized = true;
    }
  }
  static struct DictInit {
    DictInit() {
      TriggerDictionaryInitialization_libRawObjs_FChannelData_dict_Impl();
    }
  } __TheDictionaryInitializer;
}
void TriggerDictionaryInitialization_libRawObjs_FChannelData_dict() {
  TriggerDictionaryInitialization_libRawObjs_FChannelData_dict_Impl();
}
