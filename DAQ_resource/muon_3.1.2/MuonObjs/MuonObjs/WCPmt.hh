...
public:
  ...
  void SetFmaxx(int x);
  void SetIBin(int x);
  void SetVariables(double qtot, double qmax, double fmax, int qmaxx, double ped, double rms);
...
inline void WCPmt::SetVariables(double qtot, double qmax, double fmax, int fmaxx, double ped, double rms)
{
  fQtot = qtot;
  fQmax = qmax;
  fFmax = fmax;
