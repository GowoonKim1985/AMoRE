...
//	int histbin = (hist_range-cutx)/bw;	//bin numbers
	...
	int divbox = -1;
	int divch;
	//	double mpv[8] = {4376.9930, 4194.0885, 4864.3524, 4614.5279, 3750.4727, 3864.7289, 4127.2932, 3437.9561};
	...
	for(int i=0; i< tent; i++){
	  ...
	  //	  qcal_d = count_cal[0]+count_cal[1]+count_cal[2]+count_cal[3];	  
	  ...
	  //	  qcal_p = count_cal[4]+count_cal[5]+count_cal[6]+count_cal[7];	  
