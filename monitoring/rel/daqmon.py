...
process0 = subprocess.call(['/home/kkw/monitoring/rel/daq_value.sh'])
...
tempfile = open("/home/kkw/monitoring/rel/daq_value.txt")
#tempfile = open("/home/gowoon/influxDB/daq_value.txt")
####################################
lines=tempfile.readlines()
tempfile.close()

print(lines) # runnum, subnum, run, wcmd cnt-rate-status, iadc1 cnt-rate-status, iadc2 cnt-rate-status, current daq time, tot daq time
value = []
...
daq_trg['CDAQTIME'] = value[10]
daq_trg['TDAQTIME'] = value[11]
