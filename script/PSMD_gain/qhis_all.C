...
void qhis_all()
{
  ...
  //  chain->Add(Form("/data/amore2test/PROD/PSMD/%06d/prd_psd_daq1_%06d_00000.root", run, run));  
  //  chain->Add(Form("/data/amore2test/PROD/PSMD/%06d/prd_psd_daq2_%06d_00000.root", run, run));  
    chain->Add(Form("./data/%06d/psmd_ped_%06d.root", run, run));  
