...
void psmd_align()
{
  ...
  psmd1->Add(Form("./data/%06d/prd_psd_ped_daq1_%06d_*.root", runnum, runnum));
  //  psmd1->Add(Form("./data/%06d/prd_psd_ped_daq1_%06d_00000.root", runnum, runnum));  

  
  TChain * psmd2 = new TChain("prd_psd");
  psmd2->Add(Form("./data/%06d/prd_psd_ped_daq2_%06d_*.root", runnum, runnum));
  //  psmd2->Add(Form("./data/%06d/prd_psd_ped_daq2_%06d_00000.root", runnum, runnum));
  ...
  for(int ient1=0; ient1<tent1; ient1++){
      //  for(int ient1=0; ient1<10; ient1++){
    coin=0;
  ...
  TString anafile = Form("./data/psmd_ped_%06d.root", runnum);
