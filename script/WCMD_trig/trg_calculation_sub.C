...
void trg_calculation_sub_pbs(int subfile=0)
{
  ...
  int run[fn] = {287, 288, 294, 298, 303, 304, 315, 318, 327, 330, 339, 343, 356, 361, 368, 376, 401, 404, 405, 407, 409, 411, 413, 416, 426, 429, 435};
  int finsub[fn] = {93, 525, 76, 30, 1154, 791, 191, 689, 282, 695, 286, 94, 667, 143, 332, 18, 169, 63, 68, 23, 44, 72, 20, 16, 338, 15, 474};
