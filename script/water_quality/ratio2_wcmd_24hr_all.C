...
void ratio2_wcmd_24hr_all()
{
  ...
  */
  ...
  //  value->Branch("r_err",sigma,Form("r_err[%i]/D",tid));    

  // value->Branch("fid",fid,Form("fid[%i]/I",nch));
  
  value->Branch("hit",hit,"hit[48]/I");    
  //  value->Branch("q",q,Form("q[%i]/I",tid));    
  //  tree->Branch("evt",&evt,"evt/I");
  charge->Branch("tbit",&nch,"tbit/I");  
